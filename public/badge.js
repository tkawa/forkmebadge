...
o.showbadge = function(){
	...
	o.tabStyleCode='-moz-box-shadow:0px 1px 3px rgba(000,000,000,0.5),inset 0px 0px 1px rgba(255,255,255,0.6);-webkit-box-shadow:0px 1px 3px rgba(000,000,000,0.5),inset 0px 0px 1px rgba(255,255,255,0.6);position:fixed;'+'top:'+o.top+'px;'+'width:31px;'+'height:119px;'+'z-index:9998;'+'cursor:pointer;'+'background:'+o.color+' url(/images/badge.png);'+'background-repeat:no-repeat;';
	
	o.aboutStyleCode='position:fixed;'+'top:'+(parseInt(o.top)+106)+'px;'+'margin-top:6px;margin-left:9px;margin-right:9px;width:13px;'+'height:15px;'+'z-index:9999;'+'cursor:pointer;'+'background: url(/images/about.png);'+'background-repeat:no-repeat;';
	if(o.side=='l'){
	...
	document.getElementById('fmAbout').onclick=function(){
		window.open('https://forkmebadge.heroku.com/')
	}
